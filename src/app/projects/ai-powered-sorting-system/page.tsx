...
export const metadata: Metadata = {
  ...
  description: "Deployed a machine learning-based sorting system that classifies and routes packages in real-time, eliminating manual sortation bottlenecks.",
};

const results = ["99.9% sortation accuracy", "3× faster package processing", "70% reduction in misroutes", "Scaled to 100K+ packages/day"];
    ...
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex flex-wrap items-center gap-x-5 gap-y-2 text-sm text-muted-foreground mb-4">
                <span className="inline-flex items-center gap-1.5"><Building2 className="size-4 text-primary/60" />Innovate Distribution</span>
                <span className="inline-flex items-center gap-1.5"><Calendar className="size-4 text-primary/60" />November 2025</span>
              </div>
              <span className="inline-flex w-fit items-center rounded-full bg-primary/10 px-3 py-1 text-xs font-medium text-primary mb-4">E-Commerce Fulfillment</span>
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground tracking-tight leading-tight mb-6">AI-Powered Sorting System</h1>
              <p className="text-lg text-muted-foreground leading-relaxed mb-8 max-w-xl">Deployed a machine learning-based sorting system that classifies and routes packages in real-time, eliminating manual sortation bottlenecks.</p>
            ...
            <div className="relative aspect-4/3 rounded-2xl overflow-hidden ring-1 ring-border/50 shadow-2xl">
              <Image src="/images/project-03.jpg" alt="AI-Powered Sorting System" fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover" priority />
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">Innovate Distribution&rsquo;s manual sortation lines were the bottleneck of their entire fulfillment operation. During peak periods, sorters made classification errors that cascaded into misroutes, returns, and customer complaints. The facility processed 35K packages/day but needed to hit 100K+ to win new contracts.</p>
            </div>
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">IntelliSyncs deployed a machine learning-based vision system that classifies and routes packages in real-time — reading labels, measuring dimensions, and diverting to the correct chute in under 200ms. The ML model was trained on 2 million package images and continuously improves from every new scan. The system replaced 12 manual sortation stations with 4 AI-powered lines.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 sm:py-28 bg-background">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
            {["Computer vision + ML classification", "Real-time conveyor divert", "Edge inference hardware", "WMS integration API"].map((t) => (<Card key={t} className="text-center"><CardContent className="py-6"><Cpu className="size-8 text-primary mx-auto mb-3" /><div className="text-sm font-semibold text-foreground">{t}</div></CardContent></Card>))}
          </div>
        </div>
      </section>
      ...
      <section className="py-20 sm:py-28 bg-card">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <blockquote className="text-xl sm:text-2xl font-medium text-foreground leading-relaxed mb-6">&ldquo;Our sortation bottleneck disappeared overnight. The system learns from every package — accuracy keeps improving. We&rsquo;re handling 3× the volume with half the footprint.&rdquo;</blockquote>
          <div className="flex items-center justify-center gap-3"><div className="flex size-10 items-center justify-center rounded-full bg-primary/10"><Star className="size-5 text-primary" /></div><div className="text-sm font-semibold text-foreground">Director of Fulfillment, Innovate Distribution</div></div>
        </div>
      </section>
